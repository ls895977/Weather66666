...
import com.lykj.aextreme.afinal.pulltorefresh.internal.FlipLoadingLayout;
import com.lykj.aextreme.afinal.pulltorefresh.internal.LoadingLayout;
import com.lykj.aextreme.afinal.pulltorefresh.internal.RotateLoadingLayout;
import com.lykj.aextreme.afinal.pulltorefresh.internal.Utils;
import com.lykj.aextreme.afinal.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	/**
	 * Initialize and show empty loading view for list view.
	 * not scrolling, so just set state and call refresh listener.
	 * Added by LuoYer
	 */
	public final void initListRefreshing() {
...
//		}
	 ...
	 * for initialize loading, and fail information
	 * @param context
	 * Added by LuoYer
	 */
	...
	private void init(Context context, AttributeSet attrs) {
		...
		// Empty view for initialize loading, and fail information - Added by LuoYer
		addEmptyView(context);
