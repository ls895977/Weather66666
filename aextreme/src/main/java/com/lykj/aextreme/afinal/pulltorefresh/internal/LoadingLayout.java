 ...
 *******************************************************************************/
package com.lykj.aextreme.afinal.pulltorefresh.internal;
...
import com.lykj.aextreme.afinal.pulltorefresh.ILoadingLayout;
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		switch (mode) {
			...
			default:
				...
				// Load in labels
				mPullLabel = context.getString(R.string.pull_to_refresh_top_pull_label);
				mRefreshingLabel = context.getString(R.string.pull_to_refresh_top_refreshing_label);
				mReleaseLabel = context.getString(R.string.pull_to_refresh_top_release_label);
				break;
		}
