...
public class ColorPickerDialog extends Dialog {
     ...
     * @param listener �ص�
     */
    public ColorPickerDialog(Context context, String title,int iconID,
    		OnColorChangedListener listener) {
    	this(context, Color.BLACK, title,iconID, listener);
    }
    ...
    public ColorPickerDialog(Context context, int initialColor, 
    		String title,int iconID,   OnColorChangedListener listener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		viewLayoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL,RelativeLayout.TRUE);
		myView.setLayoutParams(viewLayoutParams);
		
		RelativeLayout pickerViewContainer = new RelativeLayout(getContext());
		pickerViewContainer.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
		pickerViewContainer.addView(myView);
        setContentView(pickerViewContainer);
    }
