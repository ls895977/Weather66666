...
public class RealChineseTimeWeather extends LinearLayout {
    private Context context;

    private HorizontalScrollView horizontalScrollView;
    public RealChineseTimeWeather(Context context) {
    ...
    public RealChineseTimeWeather(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
    public RealChineseTimeWeather(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(){
        ...
        DrawChineseTimeWeatherView drawTimeWeatherView = new DrawChineseTimeWeatherView(context);
