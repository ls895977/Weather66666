...
public class AreaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AreaAdapter(List<ProvinceAreaModel> provinceAreaModels, Context context) {
            ...
            ((ViewHolder) holder).mTextView
                    .setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View arg0) {
                            ...
                            routeActivity.setProviceID(provinceAreaModels.get(position).getCnAreaID(),provinceAreaModels.get(position).getCnAreaName());
                        }
                    });
        }
    }
